...
<div className=' min-w-full bg-white h-[80dvh] px-5 py-[30px] flex justify-center'>
          {/* <div>
          ...
          <ul className=' flex w-full flex-col items-center text-center gap-[32px] text-[18px] font-normal text-gray-700'>
                <Link to="/post"><li className='hover:font-bold hover:underline w-full'><span className=''>Write</span></li></Link>
