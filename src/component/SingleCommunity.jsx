                ...
                <div className='flex justify-between'>
                    ...
                    <div>
                        ...
                        {modal && <div className=' bg-white rounded-md text-center p-3 absolute z-1 top-10 left-7 lg:top-5 lg:left-20 w-[80%]'>
                            ...
                            <button className='bg-purple-500 text-white md:px-2 py-1 rounded-sm border border-purple-500 text-sm'>Create Account</button>
                             <button className='text-purple-500 border border-purple-500 rounded-sm py-1 px-3 md:px-7 text-sm'>Sign In</button>
                            </div>
