...
import comment from '../assets/joseph imgs/assets/coment.png'
        ...
        <div className='w-[90] flex flex-col gap-2'>
            ...
            <div>
                ...
                <div className='flex justify-between'>
                    ...
                    <div>
                        <button onClick={handleModal} className='cursor-pointer text-[12px] md:text-sm lg:text-[16px]'>{button}</button>
                        {modal && <div className=' bg-white rounded-md text-center p-3 absolute z-1 top-10 left-7 lg:top-5 lg:left-20 w-[80%]'>
                            ...
                            <Link to="/signUp"><button className='bg-purple-500 hover:bg-purple-300 border-purple-500 cursor-pointer text-white md:px-2 py-1 rounded-sm border border-purple-500 text-sm'>Create Account</button></Link>
                             <Link to="/signIn"><button className='text-purple-500 hover:text-white border border-purple-500 cursor-pointer hover:bg-purple-300 rounded-sm py-1 px-3 md:px-7 text-sm'>Sign In</button></Link>
                            </div>
