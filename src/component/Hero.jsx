...
const Hero = () => {
  return (
    <div className="relative z-10 container mx-auto w-11/12"> {/* Added z-index positioning */}
      <div className="flex flex-col md:flex-row md:h-[400px] w-full mx-auto">
        ...
        <div className="flex flex-col w-full md:w-auto gap-[30px] md:gap-[57px] py-[20px] md:py-[41px] md:pr-[20px] items-center md:items-start">
          ...
          <div className="flex gap-[10px] flex-wrap justify-center md:justify-start">
            <button className="text-[16px] w-[120px] md:w-[170px] h-[40px] py-[5px] px-[10px] text-white bg border-[1px] rounded-sm border-purple-500 bg-purple-600 transition-colors">
              Start Writing
            </button>
